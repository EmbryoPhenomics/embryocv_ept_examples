...
def dimensionality_reduction(out):
    scaler = StandardScaler()
    # scaler.fit(out)
    out = scaler.transform(np.log(out + 1)).fi
    ...
    # Run PCA and uMap
    pca = PCA(n_components=100).fit_transform(scaled.reshape(100, 301))
...
# Calculate EPTs..
out, temp, time = batch_analysis(vids)
# Run dimensionality reduction and visualise
dimensionality_reduction()

# Calculate EPTs for a number of videos and apply dimensionality reduction to investigate
# treatment-specific clustering
calculate_epts()
mean_px = _runNestedMeanWindowCalc(vid,30,8)
epts = _freq_analysis(mean_px, 30,8)
